...
final class Version20191126211909 extends AbstractMigration
{
	...
	public function up(Schema $schema): void
	{
		...
		$this->addSql('CREATE TABLE offer (id INT AUTO_INCREMENT NOT NULL, model_id INT DEFAULT NULL, source_id INT NOT NULL, seller_id INT NOT NULL, brand_id INT DEFAULT NULL, country VARCHAR(255) NOT NULL, price_czk NUMERIC(10, 2) DEFAULT NULL, currency VARCHAR(3) DEFAULT NULL, price NUMERIC(10, 2) DEFAULT NULL, location VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, color VARCHAR(255) DEFAULT NULL, title VARCHAR(1000) NOT NULL, offer_date DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_29D6873E7975B7E7 (model_id), INDEX IDX_29D6873E953C1C61 (source_id), INDEX IDX_29D6873E8DE820D9 (seller_id), INDEX IDX_29D6873E44F5D008 (brand_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
		...
		$this->addSql('CREATE TABLE seller (id INT AUTO_INCREMENT NOT NULL, source_id INT NOT NULL, source_user_id INT DEFAULT NULL, source_username VARCHAR(255) DEFAULT NULL, profile_url VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_FB1AD3FC953C1C61 (source_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
